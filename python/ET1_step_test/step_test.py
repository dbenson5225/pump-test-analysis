...
obs_data= np.loadtxt("ET1_dd.txt")
print(obs_data)
obs_time=obs_data[:,0]
obs_dd=obs_data[:,1]
r=0.33					# Well radius
...
#plt.figure(2)
ax1.plot(tvec,final_dd,'r-',label="model")
